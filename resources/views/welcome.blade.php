...
<div
    ...
    <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
        <a href="{{ route('login.donor') }}" class="text-sm text-gray-700 underline">Log in</a>
        <a href="{{ route('register.donor') }}" class="ml-4 text-sm text-gray-700 underline">Register</a>
    </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="#"
                                                                             class="underline text-gray-900 dark:text-white">Doe para ajudar</a>
                        </div>
                    </div>

                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            Ajude diversas pessoas. Registre-se e doe agora.
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laracasts.com"
                                                                             class="underline text-gray-900 dark:text-white">Porque doar?</a>
                        </div>
                    </div>
